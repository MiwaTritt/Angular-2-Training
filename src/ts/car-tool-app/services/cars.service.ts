...
export class Cars {
    ...
    private carsData : Car[] = [
        ...
        { id: 4, make: "Tesla", model: "Model X", year: 2004, color: "white", price: 2000 },
        { id: 5, make: "Nisan", model: "Altima", year: 2000, color: "red", price: 15000 },
        { id: 6, make: "Bugatti", model: "Chiron", year: 2016, color: "blue", price: 1600000 },
